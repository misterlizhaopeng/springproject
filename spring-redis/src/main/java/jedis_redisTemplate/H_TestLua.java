...
public class H_TestLua {
    ...
    */
    ...
    public void testLuaScript() {
        ...
        // eval "local b={};b=redis.call('srandmember',KEYS[1],ARGV[1]);local str=''; local obj={}; for k,v in pairs(b)do  table.insert(obj,''..v..'');end ;
        // local cc=redis.call('hmget','hash-question', unpack(obj));    return cc;" 1 set-question 5

        //eval "local b={};b=redis.call('srandmember',KEYS[1],ARGV[1]);local str=''; local obj={}; for k,v in pairs(b)do  table.insert(obj,''..v..'');end ;
        // local cc=redis.call('hmget',KEYS[2], unpack(obj));    return cc;" 2 set-question  hash-question 3
        //redis-end
