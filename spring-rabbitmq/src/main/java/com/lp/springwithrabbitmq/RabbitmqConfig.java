...
import com.lp.springwithrabbitmq.testpak.conveter.LpImageConverter;
import com.lp.springwithrabbitmq.testpak.conveter.LpWordConverter;
import com.lp.springwithrabbitmq.testpak.messagedelegate.LpMsgDelegate;
...
public class RabbitmqConfig {
    ...
    public ConnectionFactory connectionFactory () {
        ...
        cachingConnectionFactory.setAddresses("192.168.25.140"); //:5672
        cachingConnectionFactory.setPort(5672);
        cachingConnectionFactory.setVirtualHost("consu_definition");
        cachingConnectionFactory.setUsername("lisi");
        cachingConnectionFactory.setPassword("lisi");
    ...
    public TopicExchange topicExchange() {
        TopicExchange topicExchange = new TopicExchange("lp.topic.exchange",true,false);
        return topicExchange;
    }

    @Bean
    public DirectExchange directExchange() {
        DirectExchange directExchange = new DirectExchange("lp.direct.exchange",true,false);
        return directExchange;
    }

    @Bean
    public FanoutExchange fanoutExchange() {
        FanoutExchange fanoutExchange = new FanoutExchange("lp.faout.exchange",true,false);
    ...
    public Binding fanoutBinding() {
        //队列绑定到交换机上即可，此时，交换机接受到的消息，就会被绑定的队列接受到；
    ...
    public SimpleMessageListenerContainer simpleMessageListenerContainer() {
        ...
        //创建消息监听适配器对象
        //自己创建一个消息委托器对象
        MessageListenerAdapter messageListenerAdapter = new MessageListenerAdapter(new LpMsgDelegate());
...
//        //版本问题 需要设置信任的包
//        javaTypeMapper.setTrustedPackages("com.lp.entity");
//        //json转java得
...
//        messageConverter.addDelegate("img/png", new LpImageConverter());
//        messageConverter.addDelegate("img/jpg",new LpImageConverter());
//        messageConverter.addDelegate("application/word",new LpWordConverter());
//        messageConverter.addDelegate("word",new LpWordConverter());
//
//
